...
class Settings:
    ...
    ocr_text_dir: str = os.getenv("OCR_TEXT_DIR", "./data/processed/ocr_text")
    vector_base_dir: str = os.getenv("VECTOR_BASE_DIR", "./vector_db")
    chinese_kg_path: str = os.getenv("CHINESE_KG_PATH", "./resources/chinese_medical_kg.json")
    redis_url: str = os.getenv("REDIS_URL", "")
    task_ttl_seconds: int = int(os.getenv("TASK_TTL_SECONDS", "86400"))
    enable_paddleocr: bool = _env_bool("ENABLE_PADDLEOCR", True)
