...
REM Start the Chinese-data FastAPI backend for local Apifox testing.
...
echo [INFO] Starting backend for Apifox at http://%BACKEND_HOST%:%BACKEND_PORT%
echo [INFO] OpenAPI docs: http://%BACKEND_HOST%:%BACKEND_PORT%/docs
